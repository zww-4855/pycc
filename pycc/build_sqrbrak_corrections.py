...
def buildFO_t2dagt2sqr_to_T3(T2,T2dag,W,o,v):
    rooovvv = 0.250000000 * np.einsum("ilab,mnde,delm,jknc->ijkabc",T2,T2,T2dag,W[o,o,o,v],optimize="optimal")
    rooovvv += 0.125000000 * np.einsum("lmab,inde,delm,jknc->ijkabc",T2,T2,T2dag,W[o,o,o,v],optimize="optimal")
    rooovvv += -0.250000000 * np.einsum("lmab,inde,deln,jkmc->ijkabc",T2,T2,T2dag,W[o,o,o,v],optimize="optimal")
    rooovvv += 0.250000000 * np.einsum("ijad,lmef,delm,kfbc->ijkabc",T2,T2,T2dag,W[o,v,v,v],optimize="optimal")
    rooovvv += -1.000000000 * np.einsum("ilad,mnbe,delm,jknc->ijkabc",T2,T2,T2dag,W[o,o,o,v],optimize="optimal")
    rooovvv += -0.500000000 * np.einsum("ilad,mnbe,demn,jklc->ijkabc",T2,T2,T2dag,W[o,o,o,v],optimize="optimal")
    rooovvv += -1.000000000 * np.einsum("ilad,jmef,delm,kfbc->ijkabc",T2,T2,T2dag,W[o,v,v,v],optimize="optimal")
    rooovvv += -0.500000000 * np.einsum("ilad,jmef,eflm,kdbc->ijkabc",T2,T2,T2dag,W[o,v,v,v],optimize="optimal")
    rooovvv += 0.250000000 * np.einsum("lmad,ijef,delm,kfbc->ijkabc",T2,T2,T2dag,W[o,v,v,v],optimize="optimal")
    rooovvv += 0.125000000 * np.einsum("lmad,ijef,eflm,kdbc->ijkabc",T2,T2,T2dag,W[o,v,v,v],optimize="optimal")
    return rooovvv
